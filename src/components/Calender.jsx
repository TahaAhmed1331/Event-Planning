  ...
  return (
    <div className='flex flex-col items-center'>
      <div
        ...
        backdrop-blur-lg bg-white/40 h-auto rounded-lg w-full max-w-md px-4 mb-2'
      >
        <Button
      ...
      <div
        ...
        backdrop-blur-lg bg-white/40 h-auto rounded-lg w-full max-w-md'
      >
        ...
        {daysArray.map((day, index) => {
          ...
          return (
            <div
              key={index}
              className='py-[0.2rem] relative flex items-center justify-center'
            >
              {day ? (
                <div
                  className={`w-8 h-8 flex cursor-pointer items-center justify-center rounded-full 
                    ${
                      marked
