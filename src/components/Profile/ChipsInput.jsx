...
const ChipsInput = ({ label, chips, setChips, placeholder }) => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-wrap items-center gap-2 px-2 py-2 border border-gray-300 rounded-xl bg-[#f5f3f1]">
        {chips.map((chip, idx) => (
          <div
            key={idx}
        ...
        <input
          type="text"
          className="flex-grow bg-transparent outline-none text-sm px-1 py-1"
